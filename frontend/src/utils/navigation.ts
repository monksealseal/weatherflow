...
export const navigationMenu: MenuItem[] = [
  {
    ...
    label: 'NHC Products',
    icon: '\u{1F300}',
    description: 'National Hurricane Center products',
    children: [
      {
        id: 'nhc-outlook',
        label: 'Tropical Outlook',
        icon: '\u{1F30A}',
        path: '/nhc/outlook',
        description: 'Tropical Weather Outlook (2-day / 5-day)',
        badge: 'Live',
      },
      {
        id: 'nhc-active-storms',
        label: 'Active Storms',
        icon: '\u{26C8}\uFE0F',
        path: '/nhc/active-storms',
        description: 'Currently active tropical cyclones',
        badge: 'Live',
      },
      {
        id: 'nhc-public-advisory',
        label: 'Public Advisory',
        icon: '\u{1F4E2}',
        path: '/nhc/public-advisory',
        description: 'Tropical Cyclone Public Advisory (TCP)',
      },
      {
        id: 'nhc-forecast-advisory',
        label: 'Forecast Advisory',
        icon: '\u{1F4CB}',
        path: '/nhc/forecast-advisory',
        description: 'Tropical Cyclone Forecast/Advisory (TCM)',
      },
      {
        id: 'nhc-discussion',
        label: 'TC Discussion',
        icon: '\u{1F4AC}',
        path: '/nhc/discussion',
        description: 'Tropical Cyclone Discussion (TCD)',
      },
      {
        id: 'nhc-track-cone',
        label: 'Track Forecast Cone',
        icon: '\u{1F5FA}\uFE0F',
        path: '/nhc/track-cone',
        description: 'Forecast cone and watch/warning graphics',
      },
      {
        id: 'nhc-wind-probabilities',
        label: 'Wind Probabilities',
        icon: '\u{1F4CA}',
        path: '/nhc/wind-probabilities',
        description: 'Surface wind speed probabilities (34/50/64 kt)',
      },
      {
        id: 'nhc-storm-surge',
        label: 'Storm Surge',
        icon: '\u{1F30A}',
        path: '/nhc/storm-surge',
        description: 'Storm surge watches, warnings, and inundation',
      },
      {
        id: 'nhc-marine',
        label: 'Marine Forecasts',
        icon: '\u{26F5}',
        path: '/nhc/marine',
        description: 'Offshore, high seas, and coastal forecasts',
      },
      {
        id: 'nhc-reports',
        label: 'TC Reports',
        icon: '\u{1F4D1}',
        path: '/nhc/reports',
        description: 'Post-season tropical cyclone reports archive',
      },
    ],
  },
  {
